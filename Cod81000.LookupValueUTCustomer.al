codeunit 81000 "LookupValue UT Customer"
{
    ...
    begin
        ...
        SetLookupValueOnCustomer(Customer, LookupValueCode, DoModify());
    ...
    begin
        ...
        //[GIVEN] A non-existing lookup value value
        ...
        asserterror SetLookupValueOnCustomer(Customer, LookupValueCode, DoNotModify());
    ...
    local procedure SetLookupValueOnCustomer(var Customer: record Customer; LookupValueCode: Code[10]; CallModify: boolean)
    begin
    ...
    local procedure DoModify(): Boolean
    begin
        exit(true)
    end;

    local procedure DoNotModify(): Boolean
    begin
        exit(false)
    end;
    ...
    begin
        with CustomerCard do begin
            //
            Assert.IsFalse("Lookup Value Code".Editable(), '');
            //
